...
def route_by_intent(state: AdaptiveRAGState) -> Literal["analyze_query", "generate_answer"]:
    """
...
def check_query_quality(state: AdaptiveRAGState) -> Literal["retrieve", "skip_to_generate"]:
    """
